...
while (trials < 5):
    ...
    while (True):  # this unit(of experiment) is repeated #
        ...
        if frame_number < 13 * framerate:
            ...
            dir = 0
        elif frame_number >= 15 * framerate and frame_number < 30 * framerate:
            dir = direction

        elif frame_number >= 30 * framerate and frame_number < 45 * framerate:
            dir = 0

        elif frame_number >= 45 * framerate and frame_number < 60 * framerate:
            dir = (-1) * direction
