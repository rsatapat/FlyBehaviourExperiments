...
while (trials < 120):
    ...
    while (True):  # this unit(of experiment) is repeated #
        ...
        elif frame_number >= (loom_time+0.4) * framerate and frame_number < 10 * framerate:
            dir = direction
            loom_speed_current = 0
            wheel_stim.ori = (wheel_stim.ori + dir * angle - closedloop_gain * fly_turn) % 360
            wheel_stim.draw()
        ...
        writer_csv.writerow([pos[0][0], pos[0][1], fly_frame_ori, timestamp, dir, loom_speed_current])
