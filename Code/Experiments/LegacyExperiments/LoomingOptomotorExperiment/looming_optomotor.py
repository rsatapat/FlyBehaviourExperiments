...
while (trials < 150):
    ...
    while (True):  # this unit(of experiment) is repeated #
        ...
        if frame_number >= 0 * framerate and frame_number < 5 * framerate:
            dir = 0
        ...
        elif frame_number >= 5 * framerate and frame_number < 5.4 * framerate:
            dir = 0
            wheel_stim.ori = (wheel_stim.ori + dir * angle - closedloop_gain * fly_turn) % 360
            wheel_stim.draw()
        ...
        elif frame_number >= 5.4 * framerate and frame_number < 10 * framerate:
            dir = 0
            wheel_stim.ori = (wheel_stim.ori + dir * angle - closedloop_gain * fly_turn) % 360
            wheel_stim.draw()
            dot_stim.fillColor = (0, 0, 0)
        ...
        elif frame_number >= (10+ loom_time+0.4) * framerate and frame_number < 20 * framerate:
            dir = direction
            wheel_stim.ori = (wheel_stim.ori + dir * angle - closedloop_gain * fly_turn) % 360
            wheel_stim.draw()
            dot_stim.fillColor = (0, 0, 0)
        ...
        elif frame_number >= (20 + loom_time + 0.4) * framerate and frame_number < 30 * framerate:
            dir = direction
            wheel_stim.ori = (wheel_stim.ori + dir * angle - closedloop_gain * fly_turn) % 360
            # wheel_stim.draw()
            dot_stim.fillColor = (0, 0, 0)
