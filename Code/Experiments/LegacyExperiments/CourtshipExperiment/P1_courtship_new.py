...
while (trials < 40):
    ...
    while (True):
        ...
        #####################################
        x1 = (pos[0][0] - 512) / w_ratio + w_rem
        y1 = (pos[0][1] - 512) / h_ratio + h_rem
        dot_stim2.pos = [[x1, y1]]
        #####################################
        ...
        if frame_number == 0:
            ...
            stimulus_inst = objects.stim_inst([stimulus, float(dot_stim.radius), list(dot_stim.fillColor), list(win.color), list(dot_stim2.fillColor)],on_time, off_time, frequency,
