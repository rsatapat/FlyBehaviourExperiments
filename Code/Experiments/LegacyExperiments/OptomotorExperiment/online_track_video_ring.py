...
while (trials < 30):
    ...
    # ring_size = random.choice([10, 20, 25, 40, 50, 60, 75, 90])
    ring_size = random.choice([10, 20, 25, 40, 50])
    stimulus_image_pinwheel = stimulus + '_' + str(bars) + '_' + str(ring_size) + '.png'
    ...
    while (True):
        ...
        if frame_number == 0:
            ...
            stimulus_inst = objects.stim_inst([stimulus, stimulus_image, ring_size, list(wheel_stim.size)[0]], direction, bars, Hz,
