...
the pinwheel has two or more independent sections that rotate such that artificial translational optic flow is generated
'''
...
while (trials < 120):
    ...
    print(trials, direction, stimulus_side, syn_or_anti)
    no_of_sections = 2
    frames_lost = 0
