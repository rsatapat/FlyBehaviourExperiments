...
class exp:
    def __init__(self,date,time,bg,fg,source_file):
        self.time = time                ## time of inititation of the experiment
        self.date = date                ## date on which experiment was conducted
        self.bg = bg                    ## value of background({-1,0,1})
        self.fg = fg
        self.src_file = source_file     ## name of file in which data/video is stored
